...
// تم إزالة الاستيراد غير المستخدم لـ admin_user_profile_screen.dart

class DriverSettlementHistoryScreen extends StatefulWidget {
  const DriverSettlementHistoryScreen({super.key});

  @override
  State<DriverSettlementHistoryScreen> createState() => _DriverSettlementHistoryScreenState();
}

class _DriverSettlementHistoryScreenState extends State<DriverSettlementHistoryScreen> {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            debugPrint("Driver Settlement History Stream Error: ${snapshot.error}");
            return Center(
              child: Padding(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ExpansionTile(
                  ...
                  subtitle: Text(
                    'المبلغ: ${totalAmount.toStringAsFixed(0)} دينار | الحالة: ${_translateSettlementStatus(settlementStatus)}',
